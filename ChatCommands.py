...
simple_chat_commands = { 'a':[{'input':x_inputs.A, 'value':True, 'delay':0}, {'input':x_inputs.A, 'value':False, 'delay':.05}], 'b':[{'input':x_inputs.B,  'value':True, 'delay':0}, {'input':x_inputs.B, 'value':False, 'delay':.05}], 'x':[{'input':x_inputs.X, 'value':True, 'delay':0}, {'input':x_inputs.X, 'value':False, 'delay':.05}], 'y':[{'input':x_inputs.Y, 'value':True, 'delay':0}, {'input':x_inputs.Y, 'value':False, 'delay':.05}], 'dpad up':[{'input':x_inputs.DPAD_UP, 'value':True, 'delay':0}, {'input':x_inputs.DPAD_UP, 'value':False, 'delay':.05}], 'dpad down':[{'input':x_inputs.DPAD_DOWN, 'value':True, 'delay':0}, {'input':x_inputs.DPAD_DOWN, 'value':False, 'delay':.05}], 'dpad left':[{'input':x_inputs.DPAD_LEFT, 'value':True, 'delay':0},  {'input':x_inputs.DPAD_LEFT, 'value':False, 'delay':.05}], 'dpad right':[{'input':x_inputs.DPAD_RIGHT, 'value':True, 'delay':0}, {'input':x_inputs.DPAD_RIGHT, 'value':False, 'delay':.05}], 'l1':[{'input':x_inputs.BUMPER_LEFT, 'value':True, 'delay':0}, {'input':x_inputs.BUMPER_LEFT, 'value':False, 'delay':.05}], 'l2':[{'input':x_inputs.TRIGGER_LEFT, 'value':1.0, 'delay':0}, {'input':x_inputs.TRIGGER_LEFT, 'value':-1.0, 'delay':.05}],'l3':[{'input':x_inputs.THUMB_LEFT, 'value':True, 'delay':0}, {'input':x_inputs.THUMB_LEFT, 'value':False, 'delay':.05}], 'r1':[{'input':x_inputs.BUMPER_RIGHT, 'value':True, 'delay':0}, {'input':x_inputs.BUMPER_RIGHT, 'value':False, 'delay':.05}], 'r2':[{'input':x_inputs.TRIGGER_RIGHT, 'value':1.0, 'delay':0},{'input':x_inputs.TRIGGER_RIGHT, 'value':-1.0, 'delay':.05}],'r3':[{'input':x_inputs.THUMB_RIGHT, 'value':True, 'delay':0},{'input':x_inputs.THUMB_RIGHT, 'value':False, 'delay':.05}], 'up':[{'input':x_inputs.STICK_LEFT_Y, 'value':1.0, 'delay':0}, {'input':x_inputs.STICK_LEFT_Y, 'value':0.0, 'delay':.1}], 'down':[{'input':x_inputs.STICK_LEFT_Y, 'value':-1.0, 'delay':0},{'input':x_inputs.STICK_LEFT_Y, 'value':0.0, 'delay':.1}],'left':[{'input':x_inputs.STICK_LEFT_X, 'value':-1.0, 'delay':0}, {'input':x_inputs.STICK_LEFT_X, 'value':0.0, 'delay':.1}],'right':[{'input':x_inputs.STICK_LEFT_X, 'value':1.0, 'delay':0},{'input':x_inputs.STICK_LEFT_X, 'value':0.0, 'delay':.1}],'c up':[{'input':x_inputs.STICK_RIGHT_Y, 'value':1.0, 'delay':0},{'input':x_inputs.STICK_RIGHT_Y, 'value':0.0, 'delay':.1}],'c down':[{'input':x_inputs.STICK_RIGHT_Y, 'value':-1.0, 'delay':0},{'input':x_inputs.STICK_RIGHT_Y, 'value':0.0, 'delay':.1}],'c left':[{'input':x_inputs.STICK_RIGHT_X, 'value':-1.0, 'delay':0},{'input':x_inputs.STICK_RIGHT_X, 'value':0.0, 'delay':.1}],'c right':[{'input':x_inputs.STICK_RIGHT_X, 'value':1.0, 'delay':0},{'input':x_inputs.STICK_RIGHT_X, 'value':0.0, 'delay':1.}],}
